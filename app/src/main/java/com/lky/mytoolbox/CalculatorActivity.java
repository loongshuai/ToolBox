...
public class CalculatorActivity extends AppCompatActivity {
    ...
    private void showPopupMenu(View view) {
        ...
        popupMenu.getMenuInflater().inflate(R.menu.calculator_menu, popupMenu.getMenu());

        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                if (item.getItemId() == R.id.action_calculator) {
                    // 启动 CalculatorActivity（当前活动）
                    // 可以忽略或添加其他逻辑
                } else if (item.getItemId() == R.id.action_scientific_calculator) {
                    // 启动 ScientificCalculatorActivity
                    startActivity(new Intent(CalculatorActivity.this, ScientificCalculatorActivity.class));
                } else if (item.getItemId() == R.id.action_unit_converter) {
                    // 启动 UnitConverterActivity
                    startActivity(new Intent(CalculatorActivity.this, UnitConverterActivity.class));
                }else if (item.getItemId() == R.id.action_programmer_calculator) {
                    // 启动 UnitConverterActivity
                    startActivity(new Intent(CalculatorActivity.this, ProgrammerCalculatorActivity.class));
                }
                return true;
            }
        });
