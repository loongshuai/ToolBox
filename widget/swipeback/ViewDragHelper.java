...
package hwdroid.widget.swipeback;
...
public class ViewDragHelper {
     ...
     * callback's
     * {@link hwdroid.widget.swipeback.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link hwdroid.widget.swipeback.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
     ...
     * {@link hwdroid.widget.swipeback.ViewDragHelper.Callback#tryCaptureView(android.view.View, int)}
     ...
     * {@link hwdroid.widget.swipeback.ViewDragHelper.Callback#getOrderedChildIndex(int)}
     * .
     *
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system
