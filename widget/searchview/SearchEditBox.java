...
//    private Validator mValidator = null;
    ...
    public SearchEditBox(Context context, AttributeSet attrs) {
        ...
        // setCompletionHint(a.getText(R.styleable.AutoCompleteTextView_completionHint)); XXX
    ...
    public void setDropDownAlwaysVisible(boolean dropDownAlwaysVisible) {
        ...
        Class clazz;
		try {
            clazz = Class.forName(android.widget.ListPopupWindow.class.getName());
...
//        }
    ...
    public void showDropDown() {
        ...
        if (!isPopupShowing()) {
    		...
    		try {
                clazz = Class.forName(android.widget.ListPopupWindow.class.getName());
    			Method method = clazz.getMethod("setListItemExpandMax", Integer.TYPE);
    			method.invoke(mPopup, EXPAND_MAX);
    		} catch (ClassNotFoundException e) {
    			e.printStackTrace();
    		} catch (NoSuchMethodException e) {
    			e.printStackTrace();
    ...
    public abstract class RightDrawableOnTouchListener implements OnTouchListener {
        ...
        public boolean onTouch(final View v, final MotionEvent event) {
            if (drawable != null) {
                ...
                if (x >= (v.getRight() - v.getLeft() - bounds.width() - fuzz)
